...
export default function Logo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      aria-label="Abroad Handy logo"
      role="img"
      {...props}
    >
      <rect width="48" height="48" rx="12" fill="#DFFF1A" />
      <path
      ...
      />
      <path
        d="M24 20C21.794 20 20 21.794 20 24C20 26.206 21.794 28 24 28C26.206 28 28 26.206 28 24C28 21.794 26.206 20 24 20ZM24 26C22.897 26 22 25.103 22 24C22 22.897 22.897 22 24 22C25.103 22 26 22.897 26 24C26 25.103 25.103 26 24 26Z"
        fill="#0D0D0D"
      />
      <circle cx="24" cy="24" r="2" fill="#0D0D0D" />
    </svg>
  );
}
